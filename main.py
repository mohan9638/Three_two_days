...
keyboard = InlineKeyboardMarkup(
    [
        [
            ...
            InlineKeyboardButton(text="🛠️ CHENNAL", url="https://t.me/+qutXY5xbN0I4OWY1"),
        ],
    ]
)
...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        f"🎉Congrats! You are using  𝄟✮͢🦋⃟≛⃝𝑩𝕣ΐ𝕛℮𝚜Ꮒ✮⃝🩷:\n\n"
        f"✦**Available Commands Here**✦\n\n"
        f"┣⪼01. /start - To Alive Check Bot \n"
        f"┣⪼02. /brijesh - for extract txt file\n"
        ...
        f"**If you have any questions, feel free to ask [ 𝄟✮͢🦋⃟≛⃝𝑩𝕣ΐ𝕛℮𝚜Ꮒ✮⃝🩷🐦](https://t.me/+1pODR7-Y1JxmODU1)! 💬**\n"
        )
    ) 
...
async def txt_handler(bot: Client, m: Message):
    ...
    if raw_text3 == '1':
        CR = '[ 𝄟✮͢🦋⃟≛⃝𝑩𝕣ΐ𝕛℮𝚜Ꮒ✮⃝🩷🐦](https://t.me/+1pODR7-Y1JxmODU1)'
    else:
        CR = raw_text3
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            try:
                cc = f'**[🎬] 𝗩𝗶𝗱_𝗜𝗱 : {str(count).zfill(3)} ✦ ———**\n\n**🎞️ 𝗧𝗶𝘁𝗹𝗲 𝗡𝗮𝗺𝗲 ➤ :** `{name1} [{res}] ⎳𝓸𝓿𝓮❥❤️━━╬٨ﮩ𝑩𝕣ΐ𝕛℮𝚜Ꮒ٨ـﮩـ Love❥.mkv`\n\n**📚 𝗕𝗮𝘁𝗰𝗵 𝗡𝗮𝗺𝗲 ➤ :** `{b_name}`\n\n**📥 𝗘𝘅𝘁𝗿𝗮𝗰𝘁𝗲𝗱 𝗕𝘆 ➤ :** {CR}'
                cc1 = f'**[📁] 𝗜𝗺𝗴_𝗜𝗱 : {str(count).zfill(3)} ✦ ———**\n\n**📁 𝗧𝗶𝘁𝗹𝗲 𝗡𝗮𝗺𝗲 ➤ :** `{name1} 𝄟✮͢🦋⃟≛⃝Anjali.pdf`\n\n**📚 𝗕𝗮𝘁𝗰𝗵 𝗡𝗮𝗺𝗲 ➤ :** `{b_name}`\n\n**📥 𝗘𝘅𝘁𝗿𝗮𝗰𝘁𝗲𝗱 𝗕𝘆 ➤ :** {CR}'
                cczip = f'**📷 IMAGE ID : {str(count).zfill(3)} ✦ ———**\n\n**📁 𝗧𝗶𝘁𝗹𝗲 𝗡𝗮𝗺𝗲 ➤ :** `{name1} 𝄟✮͢🦋⃟≛⃝Anjali.zip`\n\n**📚 𝗕𝗮𝘁𝗰𝗵 𝗡𝗮𝗺𝗲 ➤ :** `{b_name}`\n\n**📥 𝗘𝘅𝘁𝗿𝗮𝗰𝘁𝗲𝗱 𝗕𝘆 ➤ :** {CR}'
                ccimg = f'**[📁] 𝗜𝗺𝗴_𝗜𝗱 : {str(count).zfill(3)} ✦ ———**\n\n**🖼️ 𝗧𝗶𝘁𝗹𝗲 𝗡𝗮𝗺𝗲 ➤ :** `{name1} 𝄟✮͢🦋⃟≛⃝𝑩𝕣ΐ𝕛℮𝚜Ꮒ✮⃝🩷.jpg`\n\n**📚 𝗕𝗮𝘁𝗰𝗵 𝗡𝗮𝗺𝗲 ➤ :** `{b_name}`\n\n**📥 𝗘𝘅𝘁𝗿𝗮𝗰𝘁𝗲𝗱 𝗕𝘆 ➤ :** {CR}'
                ccm = f'**[🎬] 𝗩𝗶𝗱_𝗜𝗱 : {str(count).zfill(3)} ✦ ———**\n\n**🎵 𝗧𝗶𝘁𝗹𝗲 𝗡𝗮𝗺𝗲 ➤ :** `{name1} 𝄟✮͢🦋⃟≛⃝𝑩𝕣ΐ𝕛℮𝚜Ꮒ✮⃝🩷.mp3`\n\n**📚 𝗕𝗮𝘁𝗰𝗵 𝗡𝗮𝗺𝗲 ➤ :** `{b_name}`\n\n**📥 𝗘𝘅𝘁𝗿𝗮𝗰𝘁𝗲𝗱 𝗕𝘆 ➤ :** {CR}'
                cchtml = f'**📷 IMAGE ID : {str(count).zfill(3)} ✦ ———**\n\n**🌐 𝗧𝗶𝘁𝗹𝗲 𝗡𝗮𝗺𝗲 ➤ :** `{name1} 𝄟✮͢🦋⃟≛⃝𝑩𝕣ΐ𝕛℮𝚜Ꮒ✮⃝🩷.html`\n\n**📚 𝗕𝗮𝘁𝗰𝗵 𝗡𝗮𝗺𝗲 ➤ :** `{b_name}`\n\n**📥 𝗘𝘅𝘁𝗿𝗮𝗰𝘁𝗲𝗱 𝗕𝘆 ➤ :** {CR}'
                ...
                if "drive" in url:
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                               ...
                               f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [𝄟✮͢🦋⃟≛⃝𝑩𝕣ΐ𝕛℮𝚜Ꮒ✮⃝🩷🐦](https://t.me/+1pODR7-Y1JxmODU1)"
    ...
    await m.reply_text(f"`{b_name}`\n"
                       ...
                       f"├✨𝗕𝗔𝗧𝗖𝗛 𝗦𝗨𝗠𝗠𝗔𝗥𝗬✨\n"
                       f"├─────────────────────\n"
                       f"├📛𝗜𝗻𝗱𝗲𝘅 𝗥𝗮𝗻𝗴𝗲 » : {raw_text} ➠ {len(links)}\n"  
                       f"├─────────────────────\n"
    ...
    await m.reply_text(f"<pre><code>『DOWNLOAD COMPLETE 』</code></pre>")                 
